...
type CertificateStatusReportPdfPreviewPageProps = {
  locale: 'en' | 'zh'
}
...
export default function CertificateStatusReportPdfPreviewPage({ locale }: CertificateStatusReportPdfPreviewPageProps) {
        ...
        <div className="flex h-[90vh] w-full max-w-[1200px] overflow-hidden rounded-2xl bg-white shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] ring-1 ring-black/5">
          ...
          <aside className="z-20 flex w-[360px] shrink-0 flex-col border-l border-slate-200 bg-white shadow-xl">
            <div className="flex items-center justify-between border-b border-slate-100 px-6 py-5">
              ...
              <Link
                href={`/${locale}/certificate-expiration-notification-settings`}
            ...
            <div className="border-t border-slate-100 bg-slate-50 p-6">
              ...
              >
                {isZh ? '返回通知设置' : 'Back to notification settings'}
              </Link>
            </div>
          </aside>
        </div>
