...
type CertificateChainVisualPathPageProps = {
  locale: 'en' | 'zh'
}
...
export default function CertificateChainVisualPathPage({ locale }: CertificateChainVisualPathPageProps) {
          ...
          <section className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
            <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-center">
              ...
              >
                ...
                <span>{isZh ? '前往通知设置' : 'Go to notification settings'}</span>
              </Link>
            </div>
          </section>
        </div>
