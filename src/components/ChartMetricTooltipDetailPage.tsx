type ChartMetricTooltipDetailPageProps = {
  locale: 'en' | 'zh'
}
...
export default function ChartMetricTooltipDetailPage({ locale }: ChartMetricTooltipDetailPageProps) {
  return (
    <div className="flex min-h-screen flex-col bg-[#f5f7f8] text-[#111418] antialiased">
      <header className="sticky top-0 z-50 flex items-center justify-between whitespace-nowrap border-b border-gray-200 bg-white px-10 py-3">
        <div className="flex items-center gap-4 text-[#111418]">
          ...
          <h2 className="text-lg font-bold leading-tight tracking-[-0.015em]">Oxmon</h2>
        </div>

        <div className="flex flex-1 justify-end gap-8">
          <div className="flex gap-2">
            <button type="button" className="flex size-10 items-center justify-center overflow-hidden rounded-full bg-gray-100 text-[#111418] transition-colors hover:bg-gray-200">
        ...
        <div className="mb-8 flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-end">
          <div>
            <div className="mb-1 flex items-center gap-2 text-sm text-gray-500">
              ...
              <span>Hosts</span>
              <span className="material-symbols-outlined text-[14px]">chevron_right</span>
              <span className="font-medium text-[#0673e0]">server-production-01</span>
            </div>
            <h1 className="text-3xl font-bold tracking-tight text-[#111418]">CPU Usage History</h1>
          </div>
        ...
        <section className="relative overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
          <div className="border-b border-gray-100 px-8 py-5">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-3xl font-semibold tracking-tight text-[#111418]">Total CPU Utilization</h3>
                <p className="mt-1.5 text-base text-[#6E6E73]">Real-time metrics from agent v2.4.1</p>
              </div>
          ...
          <div className="relative px-6 py-6 sm:px-8">
            <svg className="w-full" viewBox="0 0 1200 460" fill="none" preserveAspectRatio="none">
              <defs>
                <linearGradient id="chartFillGradientTooltipDetail" x1="0" y1="0" x2="0" y2="1">
              ...
              {[20, 110, 200, 290, 380].map((y) => (
                <line key={y} x1="0" y1={y} x2="1200" y2={y} stroke="#e5e5ea" strokeDasharray="4 4" />
              ))}

              <line x1="620" y1="20" x2="620" y2="380" stroke="#d1d5db" strokeDasharray="5 5" />
              ...
              <circle cx="620" cy="220" r="5.5" fill="#0673e0" stroke="white" strokeWidth="3" />

              <g fill="#6E6E73" fontSize="14" fontWeight="600">
                <text x="32" y="45">0%</text>
                <text x="32" y="135">5%</text>
                <text x="32" y="225">0%</text>
                <text x="32" y="315">5%</text>
                <text x="32" y="405">0%</text>
              </g>

              <g fill="#6E6E73" fontSize="14" fontWeight="600">
                <text x="80" y="430" textAnchor="middle">10:00</text>
                <text x="200" y="430" textAnchor="middle">10:10</text>
                <text x="320" y="430" textAnchor="middle">10:20</text>
                <text x="440" y="430" textAnchor="middle">10:30</text>
                <text x="620" y="430" textAnchor="middle" fontWeight="700" fill="#111418">10:40</text>
                <text x="760" y="430" textAnchor="middle">10:50</text>
                <text x="900" y="430" textAnchor="middle">11:00</text>
                <text x="1060" y="430" textAnchor="middle">11:10</text>
              </g>
            </svg>
              ...
              <div className="relative min-w-[160px] rounded-lg border border-gray-100 bg-white p-3 shadow-[0_4px_24px_rgba(0,0,0,0.06),0_1px_2px_rgba(0,0,0,0.04)]">
                <div className="flex flex-col gap-2">
                  <div className="mb-0.5 border-b border-gray-100 pb-2">
                    <span className="block text-xs font-bold tracking-wide text-[#6E6E73]">10:42:15 AM</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <span className="tabular-nums text-sm font-bold tracking-tight text-gray-900">45.28%</span>
                  </div>

                  <div className="flex items-center justify-between gap-4">
                    <div className="flex items-center gap-2">
                      <span className="h-2.5 w-2.5 rounded-full bg-gray-300" />
                      <span className="text-sm font-medium text-gray-400">avg.load</span>
                    </div>
                    <span className="tabular-nums text-sm font-medium tracking-tight text-gray-500">32.1%</span>
                  </div>
                </div>
          ...
          {METRIC_CARDS.map((card) => (
            ...
            >
              <div className="mb-4 flex items-start justify-between">
                <div className={`rounded-lg p-2 transition-transform group-hover:scale-110 ${card.iconWrap}`}>
                  <span className="material-symbols-outlined">{card.icon}</span>
                </div>
                <span className={`flex items-center gap-1 rounded-full px-2 py-0.5 text-sm font-medium ${card.trendWrap}`}>
